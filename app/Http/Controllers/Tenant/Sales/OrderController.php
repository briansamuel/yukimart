...
class OrderController extends BaseTenantController
{
            ...
            return response()->json([
                ...
                'data' => $invoices->map(function($invoice) {
                    return [
                        ...
                        'total_amount_formatted' => number_format($invoice->total_amount, 0, ',', '.') . ' đ',
    ...
    public function checkPhoneExists()
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Lỗi khi kiểm tra s�?điện thoại: ' . $e->getMessage()
            ], 500);
        }
    }
                ...
                <div class="btn-group" role="group">
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="' . route('admin.order.print', ['orderId' => $order->id]) . '" target="_blank">
    ...
    public function testExport()
    {
        try {
            ...
            $mockOrders = collect([
                (object) [
                    'order_code' => 'HD001',
                    'customer_name' => 'Nguyễn V?n A',
                    'customer' => (object) [
                        'phone' => '0123456789',
                        'email' => 'test@example.com',
                        'address' => '123 Test Street, H? Nội'
                    ],
                    'final_amount' => 500000,
                    'amount_paid' => 300000,
                    'status' => 'processing',
                    ...
                    'channel' => 'direct',
                    'branchShop' => (object) ['name' => 'Chi nhánh H? Nội'],
    ...
    public function createTestData()
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => '?ã tạo ' . count($createdOrders) . ' đơn hàng v? ' . count($customerIds) . ' khách hàng test th?nh công!',
    ...
    public function testBulkStatusUpdate()
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Test bulk status update th?nh công!',
