...
class ReturnController extends BaseTenantController
{
    ...
    public function recordPayment(Request $request, $id)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Thanh toán ?ã ?ược ghi nhận th?nh công',
    ...
    public function bulkUpdateStatus(Request $request)
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi cập nhật h?ng loạt: ' . $e->getMessage()
            ], 500);
        }
    }
    ...
    public function bulkCancel(Request $request)
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi hủy h?ng loạt: ' . $e->getMessage()
            ], 500);
        }
    }
    ...
    public function bulkDelete(Request $request)
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi xóa h?ng loạt: ' . $e->getMessage()
            ], 500);
        }
    }
