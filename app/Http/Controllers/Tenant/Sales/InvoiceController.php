...
class InvoiceController extends BaseTenantController
{
    ...
    private function getFilterData()
    {
        ...
        $deliveryStatuses = [
            ...
            ['value' => 'returned', 'label' => 'Chuyển ho?n', 'has_plus' => true],
            ['value' => 'return_completed', 'label' => '?ã chuyển ho?n', 'has_plus' => false],
            ['value' => 'cancelled', 'label' => '?ã hủy', 'has_plus' => false],
        ];

        // Sales channels
        $salesChannels = [
            ['value' => 'offline', 'label' => 'Bán tại cửa h?ng'],
        ...
        // Delivery partners
        $deliveryPartners = [
            ['value' => 'ghn', 'label' => 'Giao H?ng Nhanh'],
    ...
    public function store()
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi tạo hóa ?ơn'
            ], 500);
        }
    }
    ...
    public function show($id)
    {
        try {
            ...
            return redirect()->route('invoice.list')->with('error', 'Không tìm thấy hóa ?ơn');
        }
    }
    ...
    public function update($id)
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi cập nhật hóa ?ơn'
            ], 500);
        }
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi xóa hóa ?ơn'
            ], 500);
        }
    }
    ...
    public function sendInvoice($id)
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi gửi hóa ?ơn'
            ], 500);
        }
    }
    ...
    public function cancelInvoice($id)
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi hủy hóa ?ơn'
            ], 500);
        }
    }
    ...
    public function createFromOrder($orderId)
    {
        try {
            ...
            if ($order->invoice) {
                return response()->json([
                    'success' => false,
                    'message' => '?ơn h?ng n?y ?ã có hóa ?ơn'
                ], 400);
            }
    ...
    {
        $badges = [
            'paid' => '<span class="badge badge-light-success">?ã thanh toán</span>',
    ...
    private function getActionButtons($invoice)
    {
        ...
        // Print button
        $buttons .= '<button type="button" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" onclick="printInvoice(' . $invoice->id . ')" title="In hóa ?ơn">
        ...
        // Send button
        $buttons .= '<button type="button" class="btn btn-icon btn-bg-light btn-active-color-info btn-sm me-1" onclick="sendInvoice(' . $invoice->id . ')" title="Gửi hóa ?ơn">
    ...
    {
        $csv = "Mã hóa ?ơn,Khách h?ng,Tổng tiền,?ã thanh toán,Trạng thái,Phương thức TT,Kênh bán,Ng?y tạo,Người bán,Người tạo,Chi nhánh\n";
...
<body>
    ...
    public function getInvoicesForReturn(Request $request)
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi tải danh sách hóa ?ơn'
            ], 500);
        }
    }
    ...
    public function getInvoiceDetails($id)
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi tải thông tin hóa ?ơn'
            ], 500);
        }
    }
        ...
        try {
            ...
            if ($invoice->invoiceItems->count() == 0) {
                ...
                return response()->json([
                    'success' => true,
                    'data' => [],
                    'message' => 'Hóa ?ơn không có sản phẩm n?o'
                ]);
            }
            ...
            return response()->json([
                'success' => false,
                'message' => 'Không tìm thấy hóa ?ơn hoặc có lỗi xảy ra: ' . $e->getMessage()
            ], 500);
        }
    }
}
