...
class CustomerController extends BaseTenantController
{
    ...
    public function getActiveCustomers()
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Lỗi khi tải danh sách khách h?ng: ' . $e->getMessage()
            ], 500);
        }
    }
        ...
        try {
            ...
            $pointsHistory = [
                [
                    ...
                    'type' => 'Tích ?iểm mua h?ng',
                    'points' => 50,
                    'note' => '?ơn h?ng HD008076',
    ...
    public function getCustomerInfo(Customer $customer)
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Có lỗi xảy ra khi tải thông tin khách h?ng',
