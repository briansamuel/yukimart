...
class RecruitmentController extends Controller
{
    ...
    function __construct(Request $request, ValidationService $validator, PostService $postService)
    {
        ...
        session()->start();
        session()->put('RF.subfolder', "tuyen-dung");
    ...
    public function ajaxGetList()
    {
        ...
        $params['query']['post_type'] = 'recruitment';
    ...
    public function add($id = 0)
    {
        ...
        $params = array('category_parent' => 0, 'category_type' => 'category_of_recruitment');
        ...
        if($id > 0) {
            ...
            return view('admin.recruitments.edit', ['news' => $news, 'categoriesCheckbox' => $categories ]);

        } else {
            
            return view('admin.recruitments.add', [ 'categoriesCheckbox' =>  $categories]);
        }
