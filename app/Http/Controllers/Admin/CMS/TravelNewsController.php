...
class  TravelNewsController extends Controller
{
    ...
    function __construct(Request $request, ValidationService $validator, PostService $postService)
    {
        ...
        session()->start();
        session()->put('RF.subfolder', "tin-tuc");
    ...
    public function index()
    {
        ...
        return view('admin.travel-news.index');
    }
    ...
    public function add($id = 0)
    {
        ...
        $params = array('category_parent' => 0, 'category_type' => 'category_of_travel');
        ...
        if($id > 0) {
            ...
            return view('admin.travel-news.edit', ['news' => $news, 'categoriesCheckbox' => $categories ]);

        } else {
            
            return view('admin.travel-news.add', [ 'categoriesCheckbox' =>  $categories]);
        }
    ...
    public function save() {
        ...
        if(isset($params['id']) && $params['id'] > 0) {
            ...
            if ($edit) {
                ...
                $delete = CategoryPostService::deleteManyByKey(array('post_id' => $params['id']));
