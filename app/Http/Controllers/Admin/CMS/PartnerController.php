...
class PartnerController extends Controller
{
    ...
    function __construct(Request $request, ValidationService $validator, PostService $postService)
    {
        ...
        session()->put('RF.thumbnailWidth', 365);
        session()->put('RF.thumbnailHeight', 295);
    }
    ...
    public function ajaxGetList()
    {
        ...
        $params['query']['post_type'] = 'partner';
    ...
    public function add($id = 0)
    {
        session()->start();
        session()->put('RF.subfolder', "doi-tac");
        $params = array('category_parent' => 0, 'category_type' => 'category_of_partner');
        ...
        if($id > 0) {
            ...
            return view('admin.partners.edit', ['news' => $news, 'categoriesCheckbox' => $categories ]);

        } else {

            return view('admin.partners.add', [ 'categoriesCheckbox' =>  $categories]);
        }
