...
Route::domain('{tenant}.yukimart.local')->middleware(['tenant.subdomain'])->group(function () {
    ...
    Route::prefix('admin')->middleware(['auth:tenant', 'tenant.resolve'])->group(function () {
        ...
        Route::prefix('invoices')->name('admin.invoice.')->group(function () {
            ...
            Route::get('/', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'index'])->name('list');
            Route::get('/ajax', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'getInvoicesAjax'])->name('ajax');
            Route::get('/api/list', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'getInvoicesForReturn'])->name('api.list');
            Route::get('/filter-users', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'getFilterUsers'])->name('filter-users');
            Route::get('/create', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'create'])->name('create');
            Route::post('/create', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'store'])->name('store');
            Route::get('/statistics', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'getStatistics'])->name('statistics');
            Route::get('/export/excel', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'exportExcel'])->name('export.excel');
            Route::get('/export/pdf', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'exportPdf'])->name('export.pdf');
            Route::post('/bulk-cancel', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'bulkCancel'])->name('bulk-cancel');
            Route::post('/from-order/{order_id}', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'createFromOrder'])->name('from-order');

            // Specific parameter routes (must come before generic /{id} route)
            Route::get('/{id}/details', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'getInvoiceDetails'])->name('details');
            Route::get('/{id}/items', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'getInvoiceItems'])->name('items');
            Route::get('/{id}/detail-panel', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'getDetailPanel'])->name('detail-panel');
            Route::get('/{id}/payment-history', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'getPaymentHistory'])->name('payment-history');
            Route::get('/{id}/edit', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'edit'])->name('edit');
            Route::get('/{id}/print', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'print'])->name('print');
            Route::post('/{id}/payment', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'recordPayment'])->name('payment');
            Route::post('/{id}/send', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'sendInvoice'])->name('send');
            Route::post('/{id}/cancel', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'cancelInvoice'])->name('cancel');

            // Generic parameter routes (must come last)
            Route::get('/{id}', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'show'])->name('show');
            Route::put('/{id}', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'update'])->name('update');
            Route::delete('/{id}', [App\Http\Controllers\Tenant\Cashbook\InvoiceController::class, 'destroy'])->name('delete');
        });
        ...
        Route::prefix('returns')->name('admin.return.')->group(function () {
            Route::get('/', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'index'])->name('list');
            Route::get('/ajax', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'getReturnsAjax'])->name('ajax');
            Route::get('/filter-users', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'getFilterUsers'])->name('filter-users');
            Route::get('/create', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'create'])->name('create');
            Route::post('/create', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'store'])->name('store');
            Route::get('/statistics', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'getStatistics'])->name('statistics');
            Route::get('/export/excel', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'exportExcel'])->name('export.excel');
            Route::get('/{id}', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'show'])->name('show');
            Route::get('/{id}/detail-panel', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'getDetailPanel'])->name('detail-panel');
            Route::get('/{id}/payment-history', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'getPaymentHistory'])->name('payment-history');
            Route::get('/{id}/edit', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'edit'])->name('edit');
            Route::put('/{id}', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'update'])->name('update');
            Route::delete('/{id}', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'destroy'])->name('delete');
            Route::post('/{id}/payment', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'recordPayment'])->name('payment');
            Route::post('/{id}/send', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'sendReturn'])->name('send');
            Route::post('/{id}/cancel', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'cancelReturn'])->name('cancel');
            Route::get('/{id}/print', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'print'])->name('print');
            Route::post('/from-invoice/{invoice_id}', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'createFromInvoice'])->name('from-invoice');
            Route::post('/bulk/update-status', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'bulkUpdateStatus'])->name('bulk.update-status');
            Route::post('/bulk/cancel', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'bulkCancel'])->name('bulk.cancel');
            Route::post('/bulk/delete', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'bulkDelete'])->name('bulk.delete');
            Route::get('/{id}/export/pdf', [App\Http\Controllers\Tenant\Cashbook\ReturnController::class, 'exportPdf'])->name('export.pdf');
        });
        ...
        Route::prefix('branch-shops')->name('admin.branch-shops.')->group(function () {
            Route::get('/', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'index'])->name('index');
            Route::get('/data', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'getData'])->name('data');
            Route::get('/create', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'create'])->name('create');
            Route::post('/', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'store'])->name('store');
            Route::get('/active', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'getActiveBranchShops'])->name('active');
            Route::get('/available', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'getAvailableBranchShops'])->name('available');
            Route::post('/switch', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'switchBranchShop'])->name('switch');
            Route::get('/dropdown/active', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'getActiveForDropdown'])->name('dropdown.active');
            Route::get('/dropdown/managers', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'getManagersForDropdown'])->name('dropdown.managers');
            Route::get('/{id}', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'show'])->name('show');
            Route::get('/{id}/edit', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'edit'])->name('edit');
            Route::put('/{id}', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'update'])->name('update');
            Route::delete('/{id}', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'destroy'])->name('destroy');
            Route::post('/bulk-action', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'bulkAction'])->name('bulk-action');
            Route::get('/statistics/summary', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'getStatistics'])->name('statistics');
            Route::get('/{branchShop}/users/data', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'getUsersData'])->name('users.data');
            Route::post('/{branchShop}/users', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'addUser'])->name('users.add');
            Route::delete('/{branchShop}/users/{user}', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'removeUser'])->name('users.remove');
            Route::put('/{branchShop}/users/{user}', [App\Http\Controllers\Tenant\Settings\WarehouseController::class, 'updateUser'])->name('users.update');
        });
        ...
        Route::prefix('settings')->name('admin.settings.')->group(function () {
            ...
            Route::get('/user-manager', [App\Http\Controllers\Tenant\Staff\UserController::class, 'index'])
                ->name('user-manager');
            Route::get('/user-manager/data', [App\Http\Controllers\Tenant\Staff\UserController::class, 'getData'])
                ->name('user-manager.data');
            Route::get('/user-manager/roles', [App\Http\Controllers\Tenant\Staff\UserController::class, 'getRoles'])
                ->name('user-manager.roles');
            Route::get('/user-manager/roles-data', [App\Http\Controllers\Tenant\Staff\UserController::class, 'getRolesData'])
                ->name('user-manager.roles-data');
            Route::post('/user-manager/store', [App\Http\Controllers\Tenant\Staff\UserController::class, 'store'])
                ->name('user-manager.store');
            Route::get('/user-manager/{id}/show', [App\Http\Controllers\Tenant\Staff\UserController::class, 'show'])
                ->name('user-manager.show');
            Route::post('/user-manager/{id}/update', [App\Http\Controllers\Tenant\Staff\UserController::class, 'update'])
                ->name('user-manager.update');
            Route::post('/user-manager/{id}/change-password', [App\Http\Controllers\Tenant\Staff\UserController::class, 'changePassword'])
                ->name('user-manager.change-password');
            Route::post('/user-manager/{id}/deactivate', [App\Http\Controllers\Tenant\Staff\UserController::class, 'deactivate'])
                ->name('user-manager.deactivate');
            Route::post('/user-manager/{id}/assign-roles', [App\Http\Controllers\Tenant\Staff\UserController::class, 'assignRoles'])
