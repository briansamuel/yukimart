"use strict";
var KTpagesList = (function () {
    var e,
        t,
        n,
        r,
        o = document.getElementById("kt_table_pages"),
        d = document.querySelector('[data-kt-page-table-filter="date_picker"]'),
        s = document.querySelector('[data-kt-page-table-filter="status"]'),
        k = document.querySelector('[data-kt-page-table-filter="search"]'),
        c = () => {
            o.querySelectorAll('[data-kt-pages-table-filter="delete_row"]').forEach((t) => {
                t.addEventListener("click", function (t) {
                    ...
                    Swal.fire({
                        ...
                        t.value ?
                            Swal.fire({ text: lang.you_have_deleted + r + "!.", icon: "success", buttonsStyling: !1, confirmButtonText: lang.ok_got_it, customClass: { confirmButton: "btn fw-bold btn-primary" } })
                                .then(function () {
                                    e.row($(n)).remove().draw();
                                })
                                .then(function () {
        ...
        l = () => {
            ...
            (t = document.querySelector('[data-kt-page-table-toolbar="base"]')), (n = document.querySelector('[data-kt-page-table-toolbar="selected"]')), (r = document.querySelector('[data-kt-page-table-select="selected_count"]'));
            const s = document.querySelector('[data-kt-page-table-select="delete_selected"]');
            c.forEach((e) => {
                ...
                s.addEventListener("click", function () {
                    ...
                    Swal.fire({
                        text: lang.are_you_sure_detele_selected_pages,
                        icon: "warning",
                        showCancelButton: !0,
                        buttonsStyling: !1,
                        confirmButtonText: lang.yes_delete_it,
                        ...
                        t.value ?
                            ...
                            "cancel" === t.dismiss &&
                            Swal.fire({ text: selected_pages_deleted, icon: "error", buttonsStyling: !1, confirmButtonText: lang.ok_got_it, customClass: { confirmButton: "btn fw-bold btn-primary" } });
                    });
                });
        }, w = () => {
                ...
                (o.querySelectorAll("tbody tr").forEach((e) => {
                    ...
                    (e = $(o).DataTable({
                        ...
                        columnDefs: [
                            ...
                            },
                            {
                                ...
                                render: function (data, type, row) {
                                    ...
                                    return `<div class="">
                                <a target="_blank" href="${row.page_edit}" class="text-gray-800 text-hover-primary mb-1">${row.page_title}</a>
                            ...
                            },
                            {
                                ...
                                orderable: false,
                                render: function (data, type, row) {
                                    return `<div class="badge badge-light-success fw-bolder">${row.page_author}</div>`;
                            ...
                            },
                            {
                                ...
                                render: function (data, type, row) {
                                    ...
                                    return `<div class="badge ${e[row.page_status].class} fw-bolder">${e[row.page_status].title}</div>`;
                                ...
                                render: function (data, type, row) {
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a target="_blank" href="${row.page_edit}" class="menu-link px-3">${lang.edit}</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-kt-pages-table-filter="delete_row">${lang.delete}</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu-->
                        ...
                        initComplete: function (settings, json) {
                            ...
                            $('#kt_table_pages_wrapper thead th').eq(1).removeClass('d-flex');
                    ...
                    $('#kt_page_status').on("change", function (t) {
