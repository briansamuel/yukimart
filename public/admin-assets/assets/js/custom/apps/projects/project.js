    ...
    return {
        init: function () {
            ...
            !(function () {
                ...
                var k = document.querySelector('[data-kt-tasks="pending"]'),
                    q = document.querySelector('[data-kt-tasks="active"]'),
                    j = document.querySelector('[data-kt-tasks="completed"]');

                if (t) {
                    var e = t.getContext("2d");
                    new Chart(e, {
                        type: "doughnut",
                        data: { datasets: [{ data: [q.innerHTML, j.innerHTML, k.innerHTML], backgroundColor: ["#00A3FF", "#50CD89", "#E4E6EF"] }], labels: ["Active", "Completed", "Yet to start"] },
                        options: {
