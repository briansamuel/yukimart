...
var KTPostList = (function () {
    var e,
        ...
        n,
        r,
        o = document.getElementById("kt_table_news"),
        y = document.getElementById("kt_news_created_at_clear"),
        d = document.querySelector('[data-kt-news-table-filter="date_picker"]'),
        s = document.querySelector('[data-kt-news-table-filter="status"]'),
        k = document.querySelector('[data-kt-news-table-filter="search"]'),
        c = () => {
            o.querySelectorAll('[data-kt-news-table-filter="delete_row"]').forEach((t) => {
        ...
        l = () => {
            ...
            (t = document.querySelector('[data-kt-news-table-toolbar="base"]')), (n = document.querySelector('[data-kt-news-table-toolbar="selected"]')), (r = document.querySelector('[data-kt-news-table-select="selected_count"]'));
            const s = document.querySelector('[data-kt-news-table-select="delete_selected"]');
            c.forEach((e) => {
                ...
                s.addEventListener("click", function () {
                    ...
                    Swal.fire({
                        text: lang.are_you_sure_detele_selected_news,
                        icon: "warning",
                        showCancelButton: !0,
                        buttonsStyling: !1,
                        confirmButtonText: lang.yes_delete_it,
                        ...
                        t.value ?
                            ...
                            "cancel" === t.dismiss &&
                            Swal.fire({ text: selected_news_deleted, icon: "error", buttonsStyling: !1, confirmButtonText: lang.ok_got_it, customClass: { confirmButton: "btn fw-bold btn-primary" } });
                    });
                });
        }, w = () => {
    ...
    const postCreatedAt = $("#kt_news_created_at").flatpickr({
                ...
                (o.querySelectorAll("tbody tr").forEach((e) => {
                    ...
                    (e = $(o).DataTable({
                        ...
                        columnDefs: [
                            ...
                            },
                            {
                                ...
                                render: function (data, type, row) {
                                    ...
                                    return `<div class="">
                                <a target="_blank" href="${row.news_edit}" class="text-gray-800 text-hover-primary mb-1">${row.post_title}</a>
                            ...
                            },
                            {
                                ...
                                orderable: false,
                                render: function (data, type, row) {
                                    return `<div class="badge badge-light-success fw-bolder">${row.post_author}</div>`;
                            ...
                            },
                            {
                                ...
                                render: function (data, type, row) {
                                    ...
                                    return `<div class="badge ${e[row.post_status].class} fw-bolder">${e[row.post_status].title}</div>`;
                                ...
                                render: function (data, type, row) {
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a target="_blank" href="${row.news_edit}" class="menu-link px-3">${lang.edit}</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-kt-news-table-filter="delete_row">${lang.delete}</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu-->
                        ...
                        initComplete: function (settings, json) {
                            ...
                            $('#kt_table_news_wrapper thead th').eq(1).removeClass('d-flex');
