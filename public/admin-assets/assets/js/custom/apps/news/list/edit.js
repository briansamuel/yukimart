"use strict";
var KTPostsEditPost = (function () {
    const e = document.getElementById("kt_edit_news_form");
            ...
            (() => {
                var o = FormValidation.formValidation(e, {
                    fields: {
                        post_title: {
                            validators: {
                                notEmpty: { message: lang.page_title_required },
                            },
                        },
                        post_description: {
                            validators: {
                ...
                const id = e.querySelector('[data-kt-news-action="id"]').value ?? 0;
