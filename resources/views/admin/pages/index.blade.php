...
@section('content')
    <div class="card">
        @include('admin.pages.elements.toolbar')
        <div class="card-body pt-0">
            <!--begin::Table-->
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_pages">
                <!--begin::Table head-->
                <thead>
                    <!--begin::Table row-->
                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        <th class="w-10px pe-2">
                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                <input class="form-check-input" type="checkbox" data-kt-check="true"
                                    data-kt-check-target="#kt_table_pages .form-check-input" value="1">
                            </div>
                        </th>
                        ...
                        <th class="text-end min-w-100px">@lang('admin.general.created_at')</th>
                    </tr>
                    <!--end::Table row-->
                </thead>
                <!--end::Table head-->
...
@section('script')
    ...
    <script src="{{ asset('admin-assets/assets/js/custom/apps/pages/list/table.js') }}"></script>
