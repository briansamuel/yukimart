...
@section('content')
    ...
    <form id="kt_add_page_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
        {{ csrf_field() }}
        <div class="row">
                        ...
                        <div class="card-body">
                            <div class="form-group row mb-5 fv-row fv-plugins-icon-container">
                                ...
                                <div class="col-12 col-lg-12 col-xl-10">
                                    <input class="form-control" type="text" value="" id="page_title" name="page_title"
                            ...
                            <div class="form-group row mb-5 fv-row fv-plugins-icon-container">
                                ...
                                <div class="col-12 col-lg-12 col-xl-10">
                                    <input class="form-control" type="text" value="" id="page_slug" name="page_slug"
                            ...
                            <div class="form-group row mb-5 fv-row fv-plugins-icon-container">
                                ...
                                <div class="col-12 col-lg-12 col-xl-10">
                                    <textarea id="page_description" rows="4" name="page_description" class="tox-target"></textarea>
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-5 fv-row fv-plugins-icon-container">
                                ...
                                <div class="col-12 col-lg-12 col-xl-10">
                                    <textarea id="page_content" name="page_content" class="tox-target"></textarea>
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card card-flush shadow-sm p-5">
                        <div class="card-body p-3">
                            ...
                            <div class="form-group row mb-5 fv-row fv-plugins-icon-container">
                                ...
                                <div class="col-8">
                                    ...
                                    id="kt_pages_created_at" data-kt-page-table-filter="date_picker" name="created_at">
                            ...
                            <div class="form-group row mb-5 fv-row fv-plugins-icon-container">
                                ...
                                <div class="col-8">
                                    <select class="form-control kt-select2" id="page_status" name="page_status">
                                        ...
                                        <option value="pending">{{ __('admin.general.spending')}}</option>
                            ...
                            <div class="form-group row mb-5 fv-row fv-plugins-icon-container">
                                ...
                                <div class="col-8">
                                    <select class="form-control kt-select2" id="page_template" name="page_template">
                                        <option value="default" selected="selected">{{ __('admin.general.default')}}</option>
                                        <option value="about-page">{{ __('admin.pages.about_page')}}</option>
                                        <option value="contact-page">{{ __('admin.pages.contact_page')}}</option>
                                    </select>
                        ...
                        <div class="card-footer p-3 d-flex justify-content-end">
                            <button type="button" class="btn btn-primary" data-kt-pages-action="submit">
                                <span class="indicator-label">{{ __('admin.pages.add')}} </span>
