...
<div class="app-navbar flex-shrink-0">
                                        ...
                                        <span class="svg-icon svg-icon-2 svg-icon-primary">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                ...
                                                <rect opacity="0.5" x="13" y="5" width="3"
                                                    height="14" rx="1.5" fill="currentColor"></rect>
    ...
    <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
        ...
        <div class="cursor-pointer symbol symbol-35px symbol-md-40px"
            data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
            data-kt-menu-placement="bottom-end">
            <img src="{{ isset(Auth::guard('admin')->user()->avatar) ? Auth::user()->avatar : asset('/admin-assets/assets/media/avatars/300-1.jpg') }}" alt="user">
        </div>
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
            ...
            <div class="menu-item px-3">
                <div class="menu-content d-flex align-items-center px-3">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <img alt="Logo"
                            src="{{ isset(Auth::guard('admin')->user()->avatar) ? Auth::user()->avatar : asset('/admin-assets/assets/media/avatars/300-1.jpg') }}">
                    </div>
                    <!--end::Avatar-->
                    <!--begin::Username-->
                    <div class="d-flex flex-column">
                        ...
                        <a href="#"
                            class="fw-bold text-muted text-hover-primary fs-7">{{ isset(Auth::guard('admin')->user()->email) ? Auth::guard('admin')->user()->email : '' }}</a>
                    </div>
                    <!--end::Username-->
                </div>
            </div>
            ...
            <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                ...
                <a href="#" class="menu-link px-5">
                    <span class="menu-title position-relative">{{ __('common.language') }}
                        <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0" id="current-language-display">
                            @if(app()->getLocale() == 'vi')
                                Tiếng Việt
                                <img class="w-15px h-15px rounded-1 ms-2" src="{{ asset('/admin-assets/assets/media/flags/vietnam.svg') }}" alt="">
                            @else
                                English
                                <img class="w-15px h-15px rounded-1 ms-2" src="{{ asset('/admin-assets/assets/media/flags/united-states.svg') }}" alt="">
                            @endif
                        </span>
                    </span>
                </a>
                ...
                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="#" class="menu-link d-flex px-5 language-option {{ app()->getLocale() == 'en' ? 'active' : '' }}" data-language="en">
                            <span class="symbol symbol-20px me-4">
                                <img class="rounded-1" src="{{ asset('/admin-assets/assets/media/flags/united-states.svg') }}" alt="">
                            </span>English</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-3">
                        <a href="#" class="menu-link d-flex px-5 language-option {{ app()->getLocale() == 'vi' ? 'active' : '' }}" data-language="vi">
                            <span class="symbol symbol-20px me-4">
                                <img class="rounded-1" src="{{ asset('/admin-assets/assets/media/flags/vietnam.svg') }}" alt="">
                            </span>Tiếng Việt</a>
                    </div>
                    <!--end::Menu item-->
                </div>
            ...
            <div class="menu-item px-5 my-1">
                <a href="{{ route('admin.settings.index') }}" class="menu-link px-5">{{ __('user_settings.account_settings') }}</a>
            </div>
            <!--end::Menu item-->
            <!--begin::Menu item-->
            <div class="menu-item px-5">
                <a href="../../demo1/dist/authentication/layouts/corporate/sign-in.html" class="menu-link px-5">Sign
                    Out</a>
            </div>
            <!--end::Menu item-->
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Theme mode handling
    const themeButtons = document.querySelectorAll('[data-kt-element="mode"]');
        ...
        .then(data => {
            if (data.success) {
                ...
                if (typeof toastr !== 'undefined') {
                    toastr.success('{{ __("common.theme_updated") }}');
                }
                ...
                if (typeof toastr !== 'undefined') {
                    toastr.error('{{ __("common.error_saving_settings") }}');
                }
            }
        })
        .catch(error => {
    ...
    function saveLanguageSetting(language) {
        fetch('{{ route("admin.settings.language.update") }}', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        .then(data => {
            if (data.success) {
                // Show success message
                if (typeof toastr !== 'undefined') {
                    toastr.success('{{ __("common.language_updated") }}');
                }

                // Redirect to change language
                window.location.href = '{{ url("/") }}/change-language/' + language;
            } else {
                if (typeof toastr !== 'undefined') {
                    toastr.error('{{ __("common.error_saving_settings") }}');
                }
