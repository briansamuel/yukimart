...
<div class="app-navbar flex-shrink-0">
    ...
    <div class="app-navbar-item ms-1 ms-lg-3">
        ...
        <a href="#"
            ...
            <!--begin::Svg Icon | path: icons/duotune/general/gen060.svg-->
            <span class="svg-icon theme-light-show svg-icon-2">
                <!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/keenthemes/metronic/docs/core/html/src/media/icons/duotune/coding/cod001.svg-->
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-250px"
            ...
            <!--begin::Menu item-->
            <div class="menu-item px-3 my-0">
                <a href="{{ route('admin.settings.retailer-info') }}" class="menu-link px-3 py-2">
    ...
    <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
        ...
        <div class="cursor-pointer symbol symbol-35px symbol-md-40px"
            data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
            data-kt-menu-placement="bottom-end">
            <img src="{{ isset(Auth::guard('admin')->user()->avatar) ? Auth::user()->avatar : asset('/admin-assets/assets/media/avatars/300-1.jpg') }}"
                alt="user">
        </div>
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
            ...
            <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                        ...
                        <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0"
                            ...
                            @if (app()->getLocale() == 'vi')
                                ...
                                <img class="w-15px h-15px rounded-1 ms-2"
                                    src="{{ asset('/admin-assets/assets/media/flags/vietnam.svg') }}" alt="">
                            @else
                                English
                                <img class="w-15px h-15px rounded-1 ms-2"
                                    src="{{ asset('/admin-assets/assets/media/flags/united-states.svg') }}"
                                    alt="">
                            @endif
                        </span>
                    </span>
                ...
                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                    ...
                    <div class="menu-item px-3">
                        <a href="#"
                            class="menu-link d-flex px-5 language-option {{ app()->getLocale() == 'en' ? 'active' : '' }}"
                            data-language="en">
                    ...
                    <div class="menu-item px-3">
                        <a href="#"
                            class="menu-link d-flex px-5 language-option {{ app()->getLocale() == 'vi' ? 'active' : '' }}"
                            data-language="vi">
                            <span class="symbol symbol-20px me-4">
                                <img class="rounded-1"
                                    src="{{ asset('/admin-assets/assets/media/flags/vietnam.svg') }}" alt="">
            ...
            <div class="menu-item px-5 my-1">
                <a href="{{ route('admin.settings.index') }}"
                    class="menu-link px-5">{{ __('user_settings.account_settings') }}</a>
            </div>
            <!--end::Menu item-->
            <!--begin::Menu item-->
            <div class="menu-item px-5">
