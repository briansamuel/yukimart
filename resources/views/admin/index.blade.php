...
<head>
    ...
    <!--begin::Custom Loading Styles-->
    <link href="{{ asset('admin-assets/assets/css/custom/loading.css') }}" rel="stylesheet" type="text/css" />
    <!--end::Custom Loading Styles-->
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
            ...
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid">
                    ...
                    <div class="app-content flex-column-fluid" id="kt_app_content">
                        <!--begin::Container-->
                        <div id="kt_app_content_container" class="app-container @yield('container-width', 'container-xxl')">
                            @yield('content')
                        </div>
                        <!--end::Container-->
                    </div>
    ...
    <script src="{{ asset('') }}admin/src/js/layout/aside.js" type="text/javascript"></script>
    <!--begin::Custom Loading Script-->
    <script src="{{ asset('admin-assets/assets/js/custom/loading.js') }}" type="text/javascript"></script>
    <!--end::Custom Loading Script-->

    <!--begin::Custom Notifications Script-->
    <script src="{{ asset('admin-assets/assets/js/custom/notifications.js') }}" type="text/javascript"></script>
    <!--end::Custom Notifications Script-->
