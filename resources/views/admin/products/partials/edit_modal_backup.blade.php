                                ...
                                <div class="col-md-4">
                                    <div class="mb-5">
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-8">
                                                <div class="border border-dashed border-gray-300 rounded text-center cursor-pointer position-relative"
                                                    ...
                                                    <div id="edit_product_main_image_preview" class="d-none w-100 h-100 position-relative">
                                                        <img src="" alt="Main Image" class="img-fluid rounded" style="max-height: 100%; max-width: 100%; object-fit: cover;" />
                                                        <button type="button" class="btn btn-sm btn-icon btn-danger position-absolute top-0 end-0 m-2"
                                                                onclick="removeProductImage('main')">
                                                            <i class="fas fa-times"></i>
                                                        </button>
                                                    </div>
                                                    <div id="edit_product_main_image_placeholder" class="p-3">
                                                        <i class="fas fa-cloud-upload-alt fs-2x text-gray-400 mb-2"></i>
                                                        <div class="text-gray-600 fw-bold fs-7">Thêm ảnh</div>
                                                        <div class="text-muted fs-8">Mỗi ảnh không quá 2 MB</div>
                                                    </div>
                                                </div>
                                            ...
                                            <!--begin::Additional images (4 small images in 2x2 grid)-->
                                            <div class="col-4">
                                                <div class="row g-2">
                                                    @for($i = 0; $i < 4; $i++)
                                                    <div class="col-6">
                                                        <div class="border border-dashed border-gray-300 rounded text-center cursor-pointer position-relative"
                                                            ...
                                                            <div id="edit_product_additional_image_preview_{{ $i }}" class="d-none w-100 h-100 position-relative">
                                                                <img src="" alt="Image {{ $i + 1 }}" class="img-fluid rounded" style="max-height: 100%; max-width: 100%; object-fit: cover;" />
                                                            ...
                                                            <div id="edit_product_additional_image_placeholder_{{ $i }}" class="p-2">
