@extends('admin.index')
@section('page-header', __('roles.edit_role'))
@section('page-sub_header', $role->display_name)

@section('content')
<!--begin::Form-->
<form id="kt_role_form" class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('admin.roles.update', $role->id) }}" method="POST">
    @csrf
    @method('PUT')
    <!--begin::Aside column-->
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body text-center pt-0">
                ...
                <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
                    ...
                    <div class="image-input-wrapper w-150px h-150px" style="background-image: url('{{ $role->avatar ?? asset('admin-assets/assets/media/svg/files/blank-image.svg') }}')"></div>
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <div class="rounded-circle {{ $role->is_active ? 'bg-success' : 'bg-danger' }} w-15px h-15px" id="kt_role_status"></div>
                </div>
                <!--end::Card toolbar-->
            </div>
            <!--end::Card header-->
            ...
            <div class="card-body pt-0">
                ...
                <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="{{ __('roles.select_role') }}" id="kt_role_status_select" name="is_active">
                    <option></option>
                    <option value="1" {{ $role->is_active ? 'selected' : '' }}>{{ __('roles.active') }}</option>
                    <option value="0" {{ !$role->is_active ? 'selected' : '' }}>{{ __('roles.inactive') }}</option>
                </select>
                <!--end::Select2-->
                <!--begin::Description-->
    ...
    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-0">
                ...
                <div class="mb-10 fv-row fv-plugins-icon-container">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="name" class="form-control mb-2" placeholder="{{ __('roles.enter_role_name') }}" value="{{ old('name', $role->name) }}" />
                    <!--end::Input-->
                    <!--begin::Description-->
                ...
                <div class="mb-10 fv-row fv-plugins-icon-container">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="display_name" class="form-control mb-2" placeholder="{{ __('roles.enter_display_name') }}" value="{{ old('display_name', $role->display_name) }}" />
                    <!--end::Input-->
                    <!--begin::Description-->
                ...
                <div class="mb-10 fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Editor-->
                    <textarea name="description" class="form-control mb-2" rows="4" placeholder="{{ __('roles.enter_description') }}">{{ old('description', $role->description) }}</textarea>
                    <!--end::Editor-->
                    <!--begin::Description-->
                ...
                <div class="mb-0 fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="number" name="sort_order" class="form-control mb-2" placeholder="0" value="{{ old('sort_order', $role->sort_order) }}" />
                    <!--end::Input-->
                    <!--begin::Description-->
                                            ...
                                            <div class="d-flex flex-wrap">
                                                @foreach ($modulePermissions as $permission)
                                                    ...
                                                    <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20 mb-3">
                                                        <input class="form-check-input" type="checkbox" value="{{ $permission->id }}" name="permissions[]" {{ in_array($permission->id, $rolePermissionIds) ? 'checked' : '' }} />
        ...
        <div class="d-flex justify-content-end">
            ...
            <button type="submit" id="kt_role_submit" class="btn btn-primary">
                <span class="indicator-label">{{ __('roles.update_role') }}</span>
...
@push('scripts')
<script src="{{ asset('admin-assets/assets/js/custom/apps/roles/edit-role.js') }}"></script>
@endpush
