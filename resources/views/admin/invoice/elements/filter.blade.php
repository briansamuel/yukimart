    ...
    <form id="kt_invoice_filter_form" class="filter-form">
        ...
        <div id="status_filter_block" class="card card-flush mb-5">
            ...
            <div  class="card-body pt-0">
                ...
                <div class="d-flex flex-column">
                    <div class="form-check form-check-custom form-check-solid mb-3">
                        <input class="form-check-input" type="checkbox" name="status[]" value="processing" id="status_processing" checked/>
                    ...
                    <div class="form-check form-check-custom form-check-solid mb-3">
                        <input class="form-check-input" type="checkbox" name="status[]" value="failed" id="status_failed"/>
        ...
        <div class="card card-flush mb-5">
            ...
            <!--begin::Card body-->
            <div class="card-body pt-0">
                <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-placeholder="Chọn người bán" data-allow-clear="true" name="seller_id" id="seller_filter">
                    <option></option>
                </select>
            </div>
            <!--end::Card body-->
        ...
        <div class="card card-flush mb-5 d-none">
            ...
            <div class="card-body pt-0">
                <div class="d-flex flex-column">
                    <div class="form-check form-check-custom form-check-solid mb-3">
                        <input class="form-check-input" type="radio" value="all" id="delivery_time_all" name="delivery_time_filter" checked/>
