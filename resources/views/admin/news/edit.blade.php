...
@endsection
@section('content')
    <form  id="kt_edit_news_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
        {{ csrf_field() }}
        <input data-kt-news-action="id" type="hidden" name="id" value="{{ $news->id }}" />
        <div class="row mb-3">
        ...
        <div class="row mb-5">
            ...
            <div class="col-md-8 col-lg-9">
                <div class="card card-flush shadow-sm mb-5">
                    ...
                    <div class="card-body">
                        <div class="form-group row mb-5 fv-row fv-plugins-icon-container">
                            <label for="post_title" class="col-12 col-lg-12 col-xl-2 required form-label">{{ __('admin.news.title') }}:</label>

                            <div class="col-12 col-lg-12 col-xl-10">
                                <input class="form-control" type="text" value="{{ $news->post_title }}" id="post_title" name="post_title"
                                    placeholder="{{ __('admin.news.title_placeholder')}}">
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="form-group row mb-5 fv-row fv-plugins-icon-container">
                            <label for="post_slug" class="col-12 col-lg-12 col-xl-2 form-label">{{ __('admin.news.slug')}}:</label>
                            <div class="col-12 col-lg-12 col-xl-10">
                                <input class="form-control" type="text" value="{{ $news->post_slug }}" id="post_slug" name="post_slug"
                                    placeholder="{{ __('admin.news.slug_placeholder')}}">
                            </div>
                        </div>
                        <div class="form-group row mb-5 fv-row fv-plugins-icon-container">
                            <label for="post_description" class="col-12 col-lg-12 col-xl-2 form-label">{{ __('admin.news.summary')}}:</label>
                            <div class="col-12 col-lg-12 col-xl-10">
                                <textarea id="post_description" rows="4" name="post_description" class="tox-target">{{ $news->post_description }}</textarea>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>

                        <div class="form-group row mb-5 fv-row fv-plugins-icon-container">
                            <label for="post_content" class="col-12 col-lg-12 col-xl-2 required form-label">{{ __('admin.news.content')}}:</label>
                            <div class="col-12 col-lg-12 col-xl-10">
                                <textarea id="post_content" name="post_content" class="tox-target">{{ $news->post_content }}</textarea>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="form-group row mb-5 fv-row fv-plugins-icon-container">
                            <label for="post_seo_title" class="col-12 col-lg-12 col-xl-2 form-label">{{ __('admin.general.seo_title')}}:</label>
                            <div class="col-12 col-lg-12 col-xl-10">
                        ...
                        <div class="form-group row mb-5 fv-row fv-plugins-icon-container">
                            <label for="post_seo_keyword" class="col-12 col-lg-12 col-xl-2 form-label">{{ __('admin.general.seo_keyword')}}:</label>
                            <div class="col-12 col-lg-12 col-xl-10">
                                <input class="form-control" type="text" value="" id="post_seo_keyword"
                                    name="post_seo_keyword" placeholder="{{ __('admin.general.seo_keyword_placeholder')}}">
                            </div>
                        </div>
                        <div class="form-group row mb-5 fv-row fv-plugins-icon-container">
                            <label for="post_seo_description" class="col-12 col-lg-12 col-xl-2 form-label">{{ __('admin.general.seo_description')}}:</label>
                            <div class="col-12 col-lg-12 col-xl-10">
                ...
                <div class="card card-flush shadow-sm p-5">
                    <div class="card-body p-3">
                            ...
                            <div class="col-8">
                                <select class="form-control kt-select2" id="language" name="language">
                                    @foreach ($arrayLang as $key => $lang)
                                        <option {{ $key == $news->language ? 'selected' : '' }} value="{{ $key }}" disabled)>{{ $lang }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row mb-5 fv-row fv-plugins-icon-container">
                            ...
                            <div class="col-8">
                                ...
                                id="kt_news_created_at" data-kt-page-table-filter="date_picker" name="created_at" value=" {{ $news->created_at_default }}">
                        ...
                        <div class="form-group row mb-5 fv-row fv-plugins-icon-container">
                            ...
                            <div class="col-8">
                                <select class="form-control kt-select2" id="post_status" name="post_status">
                                    <option value="draft" {{ 'draft' == $news->post_status ? 'selected' : '' }} >{{ __('admin.general.draft')}}</option>
                                    <option value="pending" {{ 'pending' == $news->post_status ? 'selected' : '' }}>{{ __('admin.general.pending')}}</option>
                                    <option value="pending" {{ 'pending' == $news->post_status ? 'selected' : '' }}>{{ __('admin.general.publish')}}</option>
                                </select>
                    ...
                    <div class="card-footer p-3 d-flex justify-content-end">
                        <button type="button" class="btn btn-primary" data-kt-news-action="submit">
                            <span class="indicator-label">{{ __('admin.news.edit')}} </span>
...
@section('script')
    ...
    <script src="{{ asset('admin-assets/assets/js/custom/apps/news/list/edit.js') }}"></script>
