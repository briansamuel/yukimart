...
<div class="card-header border-0 pt-6">
    ...
    <div class="card-title">
        ...
        <div class="d-flex align-items-center position-relative my-1">
            ...
            <input type="text" data-kt-news-table-filter="search"
                ...
                placeholder="{{ __('admin.news.search_news') }}">
        </div>
        <!--end::Search-->
    </div>
    <!--begin::Card title-->
    ...
    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
        <!--begin::Toolbar-->
        <div class="d-flex w-100 justify-content-end" data-kt-news-table-toolbar="base">
            <div class="input-group w-250px me-3">
                <input class="form-control form-control-solid rounded rounded-end-0" placeholder="Pick date range"
                    id="kt_news_created_at" data-kt-news-table-filter="date_picker">
                <button class="btn btn-icon btn-light" id="kt_news_created_at_clear">
            ...
            <div class="w-100 mw-150px">
                ...
                <select class="form-select form-select-solid" data-control="select2" data-hide-search="false"
                    data-placeholder="Status" data-kt-news-table-filter="status" id="kt_page_status">
                    <option></option>
                    <option value="publish">{{ __('admin.news.status_publish') }}</option>
                    <option value="pending">{{ __('admin.news.status_pending') }} </option>
                    <option value="draft">{{ __('admin.news.status_draft') }} </option>
                    <option value="trash">{{ __('admin.news.status_trash') }}</option>
                </select>
                <!--end::Select2-->
            </div>
            ...
            <!--end::Export-->
            <!--begin::Add Page-->
            <a target="_blank" href="{{ route('news.add') }}" type="button" class="btn btn-primary">
                ...
                <!--end::Svg Icon-->{{ __('admin.news.add') }}
            </a>
            <!--end::Add Page-->
        </div>
        <!--begin::Flatpickr-->
        ...
        <!--end::Toolbar-->
        <!--begin::Group actions-->
        <div class="d-flex justify-content-end align-items-center d-none" data-kt-news-table-toolbar="selected">
            <div class="fw-bolder me-5">
                <span class="me-2"
                    data-kt-news-table-select="selected_count"></span>{{ __('admin.general.selected') }}
            </div>
            <button type="button" class="btn btn-danger"
                data-kt-news-table-select="delete_selected">{{ __('admin.general.delete_selected') }}</button>
        </div>
        <!--end::Group actions-->
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <!--begin::Modal title-->
                        <h2 class="fw-bolder">{{ __('admin.news.export_news') }}</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
