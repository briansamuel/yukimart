<!--begin::Sidebar-->
<div id="invoices_filter_sidebar"
    ...
    <form id="kt_invoice_filter_form" class="filter-form">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="d-flex flex-column gap-1">
                                            <button type="button" class="btn btn-sm btn-light-primary time-option"
                                                data-value="today">Hôm nay</button>
                                            <button type="button" class="btn btn-sm btn-light-primary time-option"
                                                data-value="yesterday">Hôm qua</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="d-flex flex-column gap-1">
                                            <button type="button" class="btn btn-sm btn-light-primary time-option"
                                                data-value="this_week">Tuần này</button>
                                            <button type="button" class="btn btn-sm btn-light-primary time-option"
                                                data-value="last_week">Tuần trước</button>
                                            <button type="button" class="btn btn-sm btn-light-primary time-option"
                                                data-value="7_days">7 ngày qua</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="d-flex flex-column gap-1">
                                            ...
                                            <button type="button" class="btn btn-sm btn-light-primary time-option"
                                                data-value="30_days">30 ngày qua</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="d-flex flex-column gap-1">
                                            <button type="button" class="btn btn-sm btn-light-primary time-option"
                                                data-value="this_year">Năm này</button>
                                            <button type="button" class="btn btn-sm btn-light-primary time-option"
                                                data-value="last_year">Năm trước</button>
                                        </div>
                                    </div>
        ...
        <div id="status_filter_block" class="card card-flush mb-5">
            ...
            <div class="card-body pt-0">
                ...
                <div class="d-flex flex-column">
                    <div class="form-check form-check-custom form-check-solid mb-3">
                        <input class="form-check-input" type="checkbox" name="status[]" value="processing"
                            id="status_processing" checked />
                    ...
                    <div class="form-check form-check-custom form-check-solid mb-3">
                        <input class="form-check-input" type="checkbox" name="status[]" value="completed"
                            id="status_completed" checked />
                        <label class="form-check-label fw-semibold" for="status_completed">
                            Hoàn thành
                        </label>
                    </div>
                    <div class="form-check form-check-custom form-check-solid mb-3">
                        <input class="form-check-input" type="checkbox" name="status[]" value="failed"
                            id="status_failed" />
        ...
        <div class="card card-flush mb-5">
            ...
            <div class="card-body pt-0">
                <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true"
                    data-placeholder="Chọn người bán" data-allow-clear="true" name="seller_id" id="seller_filter">
                    <option></option>
                </select>
            </div>
            <!--end::Card body-->
        ...
        <div class="card card-flush mb-5 d-none">
            <!--begin::Card header-->
            <div class="card-header pt-5">
                <!--begin::Card title-->
                <div class="card-title d-flex align-items-center justify-content-between w-100">
            ...
            <div class="card-body pt-0">
                <div class="d-flex flex-column">
                    ...
                    <div class="form-check form-check-custom form-check-solid mb-3">
                        <input class="form-check-input" type="checkbox" value="return_completed"
                            id="delivery_return_completed" />
        ...
        <div class="card card-flush mb-5">
            ...
            <div class="card-body pt-0">
                <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true"
                    data-placeholder="Chọn kênh bán" data-allow-clear="true" name="sales_channel"
                    id="sales_channel_filter">
                    <option></option>
                </select>
            </div>
            <!--end::Card body-->
        ...
        <div class="card card-flush mb-5 d-none">
            ...
            <div class="card-body pt-0">
                <select class="form-select form-select-solid" data-kt-select2="true"
                    data-placeholder="Chọn người giao..." data-allow-clear="true" name="delivery_partner">
                    <option></option>
        ...
        <div class="card card-flush mb-5 d-none">
            ...
            <div class="card-body pt-0">
                <div class="d-flex flex-column">
                    <div class="form-check form-check-custom form-check-solid mb-3">
                        <input class="form-check-input" type="radio" value="all" id="delivery_time_all"
                            name="delivery_time_filter" checked />
                    ...
                    <div class="form-check form-check-custom form-check-solid mb-3">
                        <input class="form-check-input" type="radio" value="custom_time" id="delivery_time_custom"
                            name="delivery_time_filter" />
        ...
        <div class="card card-flush mb-5 d-none">
            ...
            <div class="card-body pt-0">
                <select class="form-select form-select-solid" data-kt-select2="true"
                    data-placeholder="Chọn Tỉnh/TP - Quận/Huyện" data-allow-clear="true" name="delivery_area">
                    <option></option>
        ...
        <div class="card card-flush mb-5">
            ...
            <div class="card-header pt-5">
                <!--begin::Card title-->
                <div class="card-title d-flex align-items-center justify-content-between w-100">
                    <h3 class="fw-bold text-dark">Phương thức thanh toán</h3>
                    <i class="fas fa-chevron-up fs-3 text-muted"></i>
                </div>
                <!--end::Card title-->
            </div>
            ...
            <div class="card-body pt-0">
                <select class="form-select form-select-solid" data-kt-select2="true"
                    data-placeholder="Chọn phương thức thanh toán..." data-allow-clear="true" name="payment_method">
                    <option></option>
        ...
        <div class="card card-flush mb-5 d-none">
            ...
            <div class="card-body pt-0">
                <select class="form-select form-select-solid" data-kt-select2="true"
                    data-placeholder="Chọn bảng giá..." data-allow-clear="true" name="price_list">
                    <option></option>
        ...
        <!-- Other income type filter removed - column doesn't exist in database -->
        <!--
        <div class="card card-flush mb-5">
            <div class="card-header pt-5">
                <div class="card-title d-flex align-items-center justify-content-between w-100">
