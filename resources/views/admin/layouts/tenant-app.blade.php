...
<head>
    ...
    <link href="{{ asset('admin-assets/css/mega-menu.css') }}" rel="stylesheet" type="text/css" />
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
    ...
    data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default overflow-hidden">
    ...
    <style>
        @media (min-width: 992px) {
            :root {
                --kt-app-header-height: 140px;
                --kt-app-header-height-actual: 140px;
            }
            .app-container {
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            <!-- begin:: Header -->
            @include('admin.tenant-header')
            <!-- end:: Header -->

            <!--begin::Wrapper-->
            <div class="app-wrapper flex-column flex-row-fluid tenant-container container-xxl" id="kt_app_wrapper">
    ...
    <!--begin::Virtual Scrollbar Script -->
    <script src="{{ asset('admin-assets/js/globals/virtual-scrollbar.js') }}"></script>
